package com.esand.customers.springdoc;
...
import com.esand.customers.web.exception.ErrorMessage;
...
@Tag(name = "Customers", description = "Contains all operations related to resources for registration, searching, correcting data, and updating status")
public interface SpringDoc {
    ...
    ResponseEntity<CustomerResponseDto> create(@RequestBody @Valid CustomerCreateDto dto);
    ...
    ResponseEntity<Void> update(@PathVariable String cpf, @RequestBody @Valid CustomerUpdateDto dto);
    ...
    ResponseEntity<Void> deleteCustomerByCpf(@PathVariable String cpf);
}