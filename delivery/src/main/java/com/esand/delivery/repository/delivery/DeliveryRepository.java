...
public interface DeliveryRepository extends JpaRepository<Delivery, Long> {
    ...
    @Query("SELECT new com.esand.delivery.web.dto.DeliveryResponseDto(d.id, d.name, d.cpf, d.title, d.sku, d.price, d.quantity, d.total, d.status, d.date) " +
    ...
    List<Delivery> findAllBySku(String sku);

    List<Delivery> findAllByCpf(String cpf);
